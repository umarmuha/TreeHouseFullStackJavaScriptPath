...
function createPlanetHTML(planet) {
  return `<div class="card">
            ...
            <h2>${planet.name}</h2>
            <p>${planet.description}</p>
            <h2>Planet Profile</h3>
            <ul>
              <li><strong>Diameter: ${planet.diameter}</li>
              <li><strong>Moons: ${planet.moons}</li>
              <li><strong>Temperature: ${planet.temp}</li>
              <li><strong>Orbit Period: ${planet.orbitDays} days ${planet.orbitYears} years</li>
            </ul>
            <p>${planet.facts}</p>
            </div>
  `
